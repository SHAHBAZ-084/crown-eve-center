  ...
  <footer className="ce-footer" aria-label="Site footer">
    <div className="ce-footer-top">
      ...
      <div className="ce-footer-col">
        <h4>Portal</h4>
        <ul>
          <li><Link to="/my/dashboard">Dashboard</Link></li>
          <li><Link to="/my/shop">Shop Bikes</Link></li>
          <li><Link to="/my/shop?type=part">Parts</Link></li>
          <li><Link to="/my/book-service">Book Service</Link></li>
        </ul>
      </div>
    ...
    <div className="ce-footer-bottom">
      ...
      <p>Main Branch — Chishtian, Pakistan · Open Daily 10AM – 8PM</p>
    </div>
  </footer>
);
